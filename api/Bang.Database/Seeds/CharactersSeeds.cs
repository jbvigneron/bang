...
namespace Bang.Database.Seeds
{
    public static class CharactersSeeds
    {
        public static IEnumerable<Character> Data { get; } = new[]
        {
            ...
            new Character
            {
                Id = CharacterEnum.CalamityJanet,
                Name = "Calamity Janet",
            ...
            new Character
            {
                Id = CharacterEnum.SlabLeFlingueur,
            ...
            new Character
            {
                Id = CharacterEnum.SuzyLafayette,
                Name = "Suzy Lafayette",
