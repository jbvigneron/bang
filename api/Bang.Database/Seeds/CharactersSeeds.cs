...
namespace Bang.Database.Seeds
{
    public static class CharactersSeeds
    {
        public static IEnumerable<Character> Fill() => new[]
        {
            ...
            new Character
            {
                Id = CharacterKind.CalamityJanet,
                Name = "Calamity Janet",
            ...
            new Character
            {
                Id = CharacterKind.SlabLeFlingueur,
            ...
            new Character
            {
                Id = CharacterKind.SuzyLafayette,
                Name = "Suzy Lafayette",
