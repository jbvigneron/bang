...
namespace Bang.Database.Seeds
{
    public static class CharactersSeeds
    {
        public static IEnumerable<Character> Fill() => new[]
        {
            ...
            new Character
            {
                Id = CharacterType.CalamityJanet,
                Name = "Calamity Janet",
            ...
            new Character
            {
                Id = CharacterType.SlabLeFlingueur,
            ...
            new Character
            {
                Id = CharacterType.SuzyLafayette,
                Name = "Suzy Lafayette",
