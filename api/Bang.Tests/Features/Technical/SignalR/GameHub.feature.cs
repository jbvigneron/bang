...
namespace Bang.Tests.Features.Technical.SignalR
{
    ...
    public partial class SignalR_HubDuJeuFeature : object, Xunit.IClassFixture<SignalR_HubDuJeuFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "GameHub.feature"
#line hidden
        
        public SignalR_HubDuJeuFeature(SignalR_HubDuJeuFeature.FixtureData fixtureData, Bang_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("fr-FR"), "Features/Technical/SignalR", "SignalR - Hub du jeu", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
            ...
            table9.AddRow(new string[] {
                        ...
                        "Hors-la-loi"});
#line 5
 testRunner.Given("une partie est créée avec ces joueurs", ((string)(null)), table9, "Sachant qu\'");
#line hidden
#line 11
 testRunner.When("le hub du jeu est connecté", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quand ");
#line hidden
        }
        ...
        [Xunit.TraitAttribute("FeatureTitle", "SignalR - Hub du jeu")]
...
#line hidden
#line 16
 testRunner.Then("un message \"PlayerJoined\" est envoyé au hub du jeu", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Alors ");
#line hidden
#line 17
...
#line hidden
#line 34
 testRunner.And("c\'est au tour de \"Jean\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Et ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                SignalR_HubDuJeuFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                SignalR_HubDuJeuFeature.FeatureTearDown();
            }
        }
    }
}
