...
namespace Bang.Tests.Drivers.Hubs
{
    public class GameHubDriver
    {
        ...
        public async Task ConnectToHubAsync()
        {
            ...
            this.connection.On<Guid, Player>(Events.Game.PlayerJoined, (gameId, player) =>
            {
                this.messages.Add(Events.Game.PlayerJoined);
            ...
            this.connection.On<Guid, CurrentGame>(Events.Game.AllPlayerJoined, (gameId, game) =>
            {
                this.messages.Add(Events.Game.AllPlayerJoined);
                this.gameContext.Current = game;
            });

            this.connection.On<Guid, string>(Events.Game.PlayerTurn, (gameId, name) =>
            {
                this.messages.Add(Events.Game.PlayerTurn);
                this.gameContext.Current.CurrentPlayerName = name;
            });

            this.connection.On<Guid, int, string, int>(Events.Game.CardsDrawn, (gameId, gameDeckCount, playerName, cardsInHand) =>
            {
                this.messages.Add(Events.Game.CardsDrawn);
