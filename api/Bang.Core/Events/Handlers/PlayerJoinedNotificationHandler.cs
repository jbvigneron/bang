...
{
    public class PlayerJoinedNotificationHandler : INotificationHandler<PlayerJoined>
    {
        private readonly IHubContext<GameHub> gameHub;
        private readonly IHubContext<PlayerHub> playerHub;

        public PlayerJoinedNotificationHandler(IHubContext<GameHub> gameHub, IHubContext<PlayerHub> playerHub)
        {
